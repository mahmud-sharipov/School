...
public class AuthController : ControllerBase
{
    ...
    [HttpPost("tech")]
    public async Task<ActionResult<string>> LoginTeacher(LoginDto loginDto)
    {
        ...
        var exDate = DateTime.UtcNow.Add(TimeSpan.FromMinutes(10));
    ...
    [HttpPost("stud")]
    public async Task<ActionResult<string>> Logint(LoginDto loginDto)
    {
        var teacher = await _context.Students.FirstOrDefaultAsync(t => t.FirstName == loginDto.Username && t.LastName == loginDto.Password);
        if (teacher == null)
        {
            return Unauthorized();
        }
